...
import { X, Flame, Database, Check, Sparkles, AlertCircle, ShieldCheck, Trash2 } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-firebase-panel border border-firebase-border rounded-xl w-full max-w-xl flex flex-col shadow-2xl overflow-hidden font-sans">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4 text-xs font-sans max-h-[80vh] overflow-y-auto">
          ...
          <div className="bg-firebase-dark p-3 rounded-lg border border-firebase-border space-y-1.5 text-[11px] text-slate-300 font-mono">
            <div className="flex items-center gap-1.5 font-bold text-emerald-400 font-sans text-xs">
              <ShieldCheck className="w-4 h-4 text-emerald-400" />
              <span>Zero-Storage Privacy Guarantee</span>
            </div>
            <p className="leading-relaxed text-slate-400 font-sans">
              Your credentials exist strictly in active browser memory during this session. No credentials or data are ever saved to disk, local storage, or server databases.
            </p>
          </div>
